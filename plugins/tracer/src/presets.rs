...
pub const PRESET_JSON: &[&str] = &[
    ...
    r#"{ "name": "Mix Glue Bands", "category": "Static-EQ", "pitch_mode": 0, "bands": 4, "smart_freq": 0.0,
         "xo1_mode": 1, "xo2_mode": 1, "xo3_mode": 1,
         "xo1_hz": 120.0, "xo2_hz": 900.0, "xo3_hz": 6000.0, "const_color": 1, "trim": 0.0,
         "b1_drive": 3.0, "b2_drive": 3.0, "b3_drive": 4.0, "b4_drive": 3.0,
         "b1_shape": 1, "b2_shape": 1, "b3_shape": 1, "b4_shape": 1,
         "b1_level": 0.0, "b2_level": 0.0, "b3_level": 0.0, "b4_level": -1.0,
         "slew": 200.0, "mix": 0.5, "out": 0.0 }"#,
