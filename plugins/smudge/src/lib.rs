            ...
            move |egui_ctx, setter, _state| {
                ...
                suite_core::ui::ScaledWindow::new("qeynos-smudge-window", Vec2::new(620.0, 520.0))
                    ...
                    .show(egui_ctx, egui_state.as_ref(), |ui| {
                        ...
                        suite_core::ui::PresetBar::new("smudge", presets.as_slice()).show(
                            ui,
                            &*params,
                            setter,
...
mod render_tests {
    ...
    /// renders/_audition/SMUDGE/<QVS_AUDITION_DIR|before>/ for the spectral-glitch / ringing detector.
    #[test]
    #[ignore]
    fn audition_render_musical_sources() {
        ...
        for (fname, s) in &jobs {
            for (tag, src) in [("pad", &pad), ("vocal", &vocal)] {
                ...
                let path = render_path("_audition/SMUDGE", &format!("{subdir}/{fname}__{tag}"));
